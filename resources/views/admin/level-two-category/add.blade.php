    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <hr>
                <form action="{{ route('admin.level-two-category.store') }}" method="POST" role="form">
                    @csrf
                    <div class="tile-body">
                     ...
                     <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="parent_id">Level One Title <span class="m-l-5 text-danger"> *</span></label>
