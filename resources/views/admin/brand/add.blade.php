        ...
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <form action="{{ route('admin.brand.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="logo">Logo <span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('logo') is-invalid @enderror" type="file" name="logo" id="logo" value="{{ old('logo') }}"/>
