...
<aside class="app-sidebar">
    <ul class="app-menu">
        ...
        <li>
         ...
         <li>
            <a class="app-menu__item"
                href="{{ route('admin.level-two-category.list') }}"><i class="app-menu__icon fa fa-group"></i>
                <span class="app-menu__label">Level Two Sub-Category</span>
            </a>
        </li>
        <li>
            <a class="app-menu__item"
                href="{{ route('admin.level-three-category.list') }}"><i class="app-menu__icon fa fa-group"></i>
                <span class="app-menu__label">Level Three Sub-Category</span>
            </a>
        </li>
         <li>
            <a class="app-menu__item"
                href="{{ route('admin.level-four-category.list') }}"><i class="app-menu__icon fa fa-group"></i>
                <span class="app-menu__label">Level Four Sub-Category</span>
            </a>
        </li>
         <li>
            <a class="app-menu__item"
                href="{{ route('admin.level-five-category.list') }}"><i class="app-menu__icon fa fa-group"></i>
        ...
        <li>
            <a class="app-menu__item"
                href="{{ route('admin.bank.list') }}"><i class="app-menu__icon fa fa-group"></i>
